    ...
    <div className="min-h-screen bg-gradient-to-b from-[#13111C] to-[#1E1B2E]">
      ...
      <main className="pt-20 pb-16">
        ...
        >
          ...
          <div className="bg-[#1A1625]/50 p-8 rounded-xl border border-[#2D2B3A] backdrop-blur-sm">
            <ContactForm />
          </div>
          ...
          <div className="mt-12 grid md:grid-cols-3 gap-6 text-center">
            <div className="p-6">
              <svg className="w-8 h-8 text-purple-500 mx-auto mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="p-6">
              ...
              <p className="text-gray-400">contacto@tuempresa.com</p>
            </div>
            ...
            <div className="p-6">
              ...
              <p className="text-gray-400">Ciudad, Estado, México</p>
            </div>
          </div>
        </motion.div>
      </main>
